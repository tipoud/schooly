    ...
    describe('Mark Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/marks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Mark', () => {
                service.create(new Mark(null)).subscribe(received => {
            ...
            it('should update a Mark', () => {
                service.update(new Mark(123)).subscribe(received => {
