    ...
    describe('Area Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/areas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Area', () => {
                service.create(new Area(null)).subscribe(received => {
            ...
            it('should update a Area', () => {
                service.update(new Area(123)).subscribe(received => {
