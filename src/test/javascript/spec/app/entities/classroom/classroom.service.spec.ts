...
describe('Service Tests', () => {
    describe('Classroom Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClassroomService);
        ...
        describe('Service methods', () => {
            ...
            it('should create a Classroom', () => {
                service.create(new Classroom(null)).subscribe(received => {
            ...
            it('should update a Classroom', () => {
                service.update(new Classroom(123)).subscribe(received => {
