...
import com.douay.schooly.config.audit.AuditEventConverter;
import com.douay.schooly.domain.PersistentAuditEvent;
...
import static com.douay.schooly.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
